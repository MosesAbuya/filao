...
<html lang="en">
<head>
  <title>About Filao Adventures &mdash; Kenya's Premier Safari Operator</title>
  <meta charset="utf-8">
...
<section class="fa-page-hero" style="background-image:url('images/Filao/East Africa/pexels-mwauraken-29093739.jpg');">
...
<!-- Testimonials -->
<section class="section-pad bg-cream" id="reviews">
  <div class="container" style="max-width:1280px;">
    <div class="fa-section-heading centered">
...
<section class="fa-cta-banner" style="background-image:url('images/Filao/East Africa/pexels-zacchaeus-rains-262050732-20523197.jpg');">
  ...
  <div class="container fa-cta-content" style="max-width:1280px;">
    <h2>Start Planning Your Dream Safari</h2>
    <p>Let our specialists craft a custom itinerary perfectly suited to your preferences.</p>
    <button data-open-planner="true" class="tc-cta" style="padding:14px 32px;border:none;cursor:pointer;font-size:12px;">Start Planning Now</button>
  </div>
</section>
